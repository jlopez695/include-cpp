# POTD1. Problem of the Day

## The Problem

Write a program that outputs the amount of time that has passed since Epoch. (Googling Epoch may help)
...
The only files that will be submitted for grading on this problem is epoch.cpp
